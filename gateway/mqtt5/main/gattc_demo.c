...
#endif
            ESP_LOGI(GATTC_TAG, "Received BLE name: %.*s (Length: %d)", adv_name_len, adv_name, adv_name_len);
            ESP_LOGI(GATTC_TAG, "Expected name: %s (Length: %d)", remote_device_name, strlen(remote_device_name));
